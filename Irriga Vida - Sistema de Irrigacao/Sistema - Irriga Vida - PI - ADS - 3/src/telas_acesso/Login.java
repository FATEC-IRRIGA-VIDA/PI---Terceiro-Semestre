			...
			public void actionPerformed(ActionEvent e) {
				...
				if(bd.getConnection()){ 
					...
					try {
						...
						//Definindo a variável recebida na seleção
						...
						if(ComboBoxPerfilAcesso.getSelectedItem().equals("Administrador"))
							...
							statusPerfil = "X"; // valor aleatório não utilizado.
						
						int cont=0; // variável de controle para as condições de leitura.
						...
						if (bd.rs.getString("NOME_USUARIO").equals(login)&&bd.rs.getString("SENHA_USU").equals(senha)&&
								bd.rs.getString("PERFIL_USUARIO").equals(statusPerfil)&&bd.rs.getString("STATUS_USUARIO").equals("A"))
							{
								...
								if(bd.rs.getString("PERFIL_USUARIO").equals("A")) {
									...
									// Chama a tela de opções para o ADMINISTRADOR.
									TelaInicial tela2 = new TelaInicial();
									tela2.setVisible(true);
									cont=1; // variável de controle para sair do laço.
								...
								else
								{
									...
									// Chama a tela de opções para o USUÁRIO.
							...
							{
								JOptionPane.showMessageDialog(null, "Usuário Desativado, contacte o ADM!");
								cont=1; // variável de controle para sair do laço.
							}
						
						}
						
						if(cont==0) // Condição que indica erros nos dados informados ou Usuário indisponível.
							JOptionPane.showMessageDialog(null, "Verifique os dados, Usuário não encontrado!");
					}
