...
public class Usuarios extends JFrame {
	...
	/***
	 * Metódo que executa uma pesquisa em toda a tabela do Usuario. (FILTRO)
	 */
	...
	public Usuarios() {
		...
		btAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//Definindo condicionais para as Datas Cadastro e Alteração.
				...
				if(dateChooserDtCadastro.getDate() != null && dateChooserDtAlteracao.getDate() !=null) {
					dtCadastro = (df.format(dateChooserDtCadastro.getDate()));    //Formatação da DT_CADASTRO_USU.
					dtAlteracao = (df.format(dateChooserDtAlteracao.getDate()));  //Formatação da DT_ALTERACAO_USU
				}
				else
