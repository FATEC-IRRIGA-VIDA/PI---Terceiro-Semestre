...
public class PlantiosUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PlantiosUsuario frame = new PlantiosUsuario();
	...
	public PlantiosUsuario() {
		...
		textTipoPlantio.setDocument( new DocumentoLimitado(10) ); //definindo o tamanho do campo
		...
		//textCodUsuario.setDocument( new DocumentoLimitado(8) ); //definindo o tamanho do campo
